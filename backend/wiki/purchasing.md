...
**Post (create bill)** commits the order to the vendor: it records the vendor's bill for the full amount (Prepaid Inventory / Accounts Payable). Goods then arrive against it — see [[receiving]].
